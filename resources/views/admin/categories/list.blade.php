        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="page-header">
                ...
                <div class="page-breadcrumb">
                    <a href="admin/category/add" class="btn btn-success">Thêm thể loại</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-primary">
                                            <div class="manage">
                                                <a href="{{URL::asset('/admin/category/update/'.$item->id)}}"><i class="fa fa-wrench" aria-hidden="true"></i></a>
...
@section('scripts')
    <script>
        ...
        $('.selectedId').change(function() {
            ...
            $.ajax({
                url: "{{URL::asset('admin/category/upstatus/')}}",
                type: 'POST',
                data: {
                    id: post_id,
                    status: show_flag,
        ...
        $(document).ready(function () {
            ...
            modalConfirm(function(confirm){
                if(confirm){
                    $.ajax({
                        url: "{{URL::asset('admin/category/trash/')}}",
                        type: 'POST',
                        data: {
                            post_id:post_id,
                        },success:function (data) {
