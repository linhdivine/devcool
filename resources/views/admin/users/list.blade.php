                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-primary">
                                            <div class="manage">
                                                <a href="{{URL::asset('/admin/users/update/'.$item->id)}}"><i class="fa fa-wrench" aria-hidden="true"></i></a>
...
@section('scripts')
    <script>
        ...
        $('.selectedId').change(function() {
            ...
            $.ajax({
                url: "{{URL::asset('admin/users/upstatus/')}}",
                type: 'POST',
                data: {
                    id: post_id,
                    status: show_flag,
        ...
        $(document).ready(function () {
            ...
            modalConfirm(function(confirm){
                if(confirm){
                    $.ajax({
                        url: "{{URL::asset('admin/users/trash/')}}",
                        type: 'POST',
                        data: {
                            post_id:post_id,
                        },success:function (data) {
